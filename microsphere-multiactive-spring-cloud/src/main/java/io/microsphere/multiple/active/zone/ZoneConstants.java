...
public interface ZoneConstants {
    ...
    String ECS_LOCATOR_PROPERTY_NAME_PREFIX = LOCATOR_PROPERTY_NAME_PREFIX + ".ecs";

    String EC2_LOCATOR_PROPERTY_NAME_PREFIX = LOCATOR_PROPERTY_NAME_PREFIX + ".ec2";

    /**
     * The enabled property name of {@link EcsContainerMetadataFileZoneLocator}
     */
    String ECS_CONTAINER_METADATA_FILE_LOCATOR_ENABLED_PROPERTY_NAME =
            ECS_LOCATOR_PROPERTY_NAME_PREFIX + ".container-metadata-file" + ENABLED_PROPERTY_NAME_SUFFIX;

    /**
     * The enabled property name of {@link EcsTaskMetadataEndpointV4ZoneLocator}
     */
    String ECS_TASK_METADATA_ENDPOINT_LOCATOR_ENABLED_PROPERTY_NAME =
            ECS_LOCATOR_PROPERTY_NAME_PREFIX + ".task-metadata-endpoint" + ENABLED_PROPERTY_NAME_SUFFIX;

    /**
     * The enabled property name of {@link Ec2AvailabilityZoneEndpointZoneLocator}
     */
    String EC2_ENDPOINT_LOCATOR_ENABLED_PROPERTY_NAME =
            EC2_LOCATOR_PROPERTY_NAME_PREFIX + ".availability-zone-endpoint" + ENABLED_PROPERTY_NAME_SUFFIX;
     ...
     */
    String ZONE_CONTEXT_BEAN_NAME = "zoneContext";

    /**
     * {@link ZoneLocator} Bean Name
     */
    String ZONE_LOCATOR_BEAN_NAME = "zoneLocator";
}
